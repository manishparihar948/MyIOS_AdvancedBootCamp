...
final class NewMockDataService_Tests: XCTestCase {
    ...
    func test_NewMockDataService_init_downloadItemsWithEscaping_doesReturnValues() {
        // Given
    ...
    func test_NewMockDataService_init_downloadItemsWithCombine_doesReturnValues() {
        // Given
        let dataService = NewMockDataService(items: nil)
    ...
    func test_NewMockDataService_init_downloadItemsWithCombine_doesReturnValuesEmptyString() {
        // Given
